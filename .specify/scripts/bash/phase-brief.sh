...
# Usage:
#   phase-brief.sh [--phase <name>] [--questions-only] [--unlock-status] [--json] [--mode normal|amend|handoff]
...
if ENV['UNLOCK_STATUS'] == 'true'
  puts "## #{phase} · unlock-status（实时 gate，非 phase.yml 缓存）"
